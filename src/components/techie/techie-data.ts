    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { name: "pokedoku.exe", type: "file", contentKey: "game-pokedoku" },
          { name: "mean-bean-machine.exe", type: "file", contentKey: "game-mean-bean-machine" },
          { name: "oregon-trail.exe", type: "file", contentKey: "game-oregon-trail" },
          { name: "poison-lizard.exe", type: "file", contentKey: "game-poison-lizard" },
